...
files = ["benchmarks/fischer_4_unsafe/p1","benchmarks/fischer_4_unsafe/p2",
		"benchmarks/fischer_4_unsafe/p3","benchmarks/fischer_4_unsafe/p4"]
config = "benchmarks/fischer_4_unsafe/config.txt"
...
for depth in range(1, n+1):
	...
	while str(S.check()) == "sat":
		...
		counterexample = check_feasibility(aut_path, graphs, automata, files, config, T, shared, ["x","svl","svr"], depth)
		count = count+1
		if counterexample != []:
			break
	total = total + count
